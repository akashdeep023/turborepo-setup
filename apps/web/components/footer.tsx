...
export default function Footer() {
	return (
		<footer className="border-t mt-auto">
			<div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
				<div>
					...
					<p className="text-muted-foreground mt-2">
						Built with Turborepo, Prisma, PostgreSQL, Tailwind, and
						Shadcn UI.
					</p>
				</div>
				<div>
				...
				<div>
					...
					<ul className="space-y-2 text-muted-foreground">
						<li>
							<Link
								href="https://x.com/akashdeep023_"
								target="_blank"
								className="hover:text-blue-600"
							>
								X (Twitter)
			...
			<div className="border-t text-center py-5 text-muted-foreground text-sm">
				© {new Date().getFullYear()} Turborepo Setup. All rights
				reserved.
			</div>
		</footer>
	);
